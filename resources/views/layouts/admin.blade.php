            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('genres.index') }}">{{ __('messages.genres') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('directors.index') }}">{{ __('messages.director') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('actors.index') }}">{{ __('messages.actors') }}</a>
                        </li>
                    </ul>
                </div>
